...
## Guidelines
- Keep compilable after every increment.
- Keep each increment to roughly ≤100 lines of new code, coherent and independently verifiable.
- Defer out-of-scope improvements rather than mixing concerns.
- Follow `docs/architecture/ARCHITECTURE.md` conventions; do not re-derive them.
